    ...
    <div class="main-content">
        <div class="welcome-text">
            ...
            <p class="text-content message">
                <strong>Te informamos que <span class="user-name">$valorNombre</span> ha sido creado exitosamente en el
                    sistema <strong>STOCKER</strong>.</strong><br><br>

                A continuación, te proporcionamos un informe detallado de los permisos actuales asignados a la
                cuenta.<br><br>
            ...
            <ul class="lista">
                ...
                <li class="li">
                    <strong>Otros permisos:</strong> <span style="color: #1976d2;">[Lista de otros permisos específicos, si
                        los hay]</span>
                </li>
            </ul>
