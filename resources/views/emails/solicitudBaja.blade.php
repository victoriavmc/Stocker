...
@section('content')
    ...
    <div class="text-content">
        ...
        <p class="description">Te informamos que hemos recibido tu solicitud para dar de baja tu cuenta en <span class="bold">STOCKER</span>. La solicitud ha sido enviada al personal de Recursos Humanos para tramitar la baja correspondiente. </p>
