...
@section('content')
    ...
    <div class="text-content">
        ...
        <p class="description">Recibimos una solicitud para recuperar tu contraseña en <span class="bold">STOCKER</span>.
            Para restablecer, haga click al siguiente boton:</p>
        <div class="pin-box">
