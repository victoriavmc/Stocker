        ...
        <details class="collapse collapse-arrow bg-base-100 hover:border-2 border-base-content">
            ...
            <ul class="collapse-content">
                ...
                <li><a wire:navigate href="{{ route('historialLaboral') }}"
                        class="justify-start text-start btn btn-ghost btn-block">Historial Laboral</a></li>
        ...
        <details class="collapse collapse-arrow bg-base-100 hover:border-2 border-base-content">
            ...
            <ul class="collapse-content">
                <li><a wire:navigate href="{{ route('productos') }}"
                        class="justify-start text-start btn btn-ghost btn-block">Productos</a></li>
                <li><a wire:navigate href="{{ route('stockGeneral') }}"
                        class="justify-start text-start btn btn-ghost btn-block">Stock General</a></li>
            </ul>
        </details>
        ...
        <details class="collapse collapse-arrow bg-base-100 hover:border-2 border-base-content">
            ...
            <ul class="collapse-content">
                <li><a wire:navigate href="{{ route('comprasDonaciones') }}"
                        class="justify-start text-start btn btn-ghost btn-block">Registrar Compras/Donaciones</a></li>
                <li><a wire:navigate href="{{ route('ventas') }}"
                        class="justify-start text-start btn btn-ghost btn-block">Registrar Ventas</a></li>
                <li><a wire:navigate href="{{ route('precioPorTemporada') }}"
                        class="justify-start text-start btn btn-ghost btn-block">Precios de Producto (Temporada)</a>
                </li>
            </ul>
        </details>
        ...
        <details class="collapse collapse-arrow bg-base-100 hover:border-2 border-base-content">
            ...
            <ul class="collapse-content">
                <li><a wire:navigate href="{{ route('historialPerdidas') }}"
                        class="justify-start text-start btn btn-ghost btn-block">Historial Pérdidas</a></li>
                <li><a wire:navigate href="{{ route('registroPerdidas') }}"
                        class="justify-start text-start btn btn-ghost btn-block">Registro Pérdidas</a></li>
            </ul>
        </details>
        ...
        <details class="collapse collapse-arrow bg-base-100 hover:border-2 border-base-content">
            ...
            <ul class="collapse-content">
                <li><a wire:navigate href="{{ route('ventasMensuales') }}"
                        class="justify-start text-start btn btn-ghost btn-block">Ventas Mensuales</a></li>
                <li><a wire:navigate href="{{ route('stockMinimo') }}"
                        class="justify-start text-start btn btn-ghost btn-block">Stock Mínimo</a></li>
                <li><a wire:navigate href="{{ route('productosMasVendidos') }}"
                        class="justify-start text-start btn btn-ghost btn-block">Productos Más Vendidos</a></li>
            </ul>
        </details>
        ...
        <details class="collapse collapse-arrow bg-base-100 hover:border-2 border-base-content">
            ...
            <ul class="collapse-content">
                ...
                <li><a wire:navigate href="{{ route('ajustesPagina') }}"
                        class="justify-start text-start btn btn-ghost btn-block">Página</a></li>
            </ul>
        </details>
    </div>
</aside>
