                    ...
                    <x-slot name="content">
                        ...
                        <div class="grid grid-cols-1 gap-6 mt-4 md:grid-cols-2">
                            ...
                            <div class="pr-4 space-y-4 border-r border-base-content/20">
                                ...
                                <x-mary-input wire:model="productCreate.brand" label="Marca" right-icon="o-tag"
                                    inline />
                                <x-mary-input wire:model="productCreate.name" label="Nombre" right-icon="o-cube"
                                    inline />
                                <x-mary-input wire:model="productCreate.code" label="Código de Barras"
                                    right-icon="o-barcode" inline />
                                ...
                                <div class="mt-3">
                                    ...
                                    <label class="block w-full max-w-xs mt-1 form-control">
                                        <select class="w-full select select-bordered"
                                            wire:model="productCreate.productType">
